...
import type {
  SnapshotModule,
  SnapshotModuleInterface,
} from "../../CMTAT_STANDALONE_FLAT.sol/SnapshotModule";
...
export class SnapshotModule__factory {
  static readonly abi = _abi;
  static createInterface(): SnapshotModuleInterface {
    return new utils.Interface(_abi) as SnapshotModuleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SnapshotModule {
    return new Contract(address, _abi, signerOrProvider) as SnapshotModule;
  }
}
