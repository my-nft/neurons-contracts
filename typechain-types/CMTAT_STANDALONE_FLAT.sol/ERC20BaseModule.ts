...
export interface ERC20BaseModuleInterface extends utils.Interface {
  functions: {
...
export interface ERC20BaseModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20BaseModuleInterface;
