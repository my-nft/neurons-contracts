...
export interface SnapshotModuleInternalInterface extends utils.Interface {
  functions: {
...
export interface SnapshotModuleInternal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SnapshotModuleInternalInterface;
